...
## Basic Instructions
### Shop Mode ###
1. Listen to customer's stories
2. Receive a boba order in-between conversation
3. Click on the "Kitchen" button to begin making the drink
4. View the recipe board for the ingredients of an order
5. Click the appropriate ingredients to create the drink
...
## Screenshots
### Pre-Evaluation - Player Writes Their Thoughts Before & AFter Playing the Main Game
<img src="/docs/PreEval.png" height="320">

### Front of Cafe - Talking to Customers & Learning About Their Imposter Syndrome
<img src="/docs/FrontOfShop.png" height="320">

### Back of Cafe - Making the Boba & Drinks for the Customers
<img src="/docs/BackOfCafe.png" height="320">

### Front of Cafe - Player has to balance their Energy & Stress With Items Mentioned By the Characters
<img src="/docs/HomeMode.png" height="320">
...
### Assest/Artwork
- Background by Victoria Nikolaeva
- Playable Items by Victoria Nikolaeva
- Characters by Victoria Nikolaeva, Brooklyn Harden, ChatGPT
- UI Designs by Victoria Nikolaeva, Gia Scozzaro , Canva Premium
### Sound Effects/Music
...
- Sound Effect by freesound_community from Pixabay
- Sound Effect by freesound_community from Pixabay
- Sound Effect by attic13 (theatticdude13@gmail.com) from Pixabay
- Sound Effect by Universfield from Pixabay
- Sound Effect by Amber from Pixabay
- Sound Effect by Shiden Beats Music from Pixabay
- Sound Effect by Yuliana from Pixabay
- Sound Effect by floraphonic from Pixabay
- Background Music: bluelike_u from Pixabay.com
## Links ##
